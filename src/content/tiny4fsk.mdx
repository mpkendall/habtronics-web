...
<img src="/logos/Tiny4FSK_FullText.svg" alt="Tiny4FSK Logo" class="w-[90%] md:w-[65%] mx-auto block" />
<img src="/images/TinyPage_TinyHeroShot.png" alt="Tiny4FSK Board" class="w-[95%] md:w-[70%] mx-auto block" />
...
<img src="/images/TinyPage_WhatItComesWith.png" alt="Tiny4FSK, headers, battery, antenna, SMA connector" class="w-[95%] md:w-[70%] mx-auto block" />
...
## Frequencies
The Tiny4FSK codebase allows the use of arbitrary UHF frequencies. This can be paired with the eight-way decoding script for horusdemodlib to track several trackers or flights at once.

## Horus Binary Protocol
Tiny4FSK uses a new, modern protocol called Horus Binary 3, developed open source by Project Horus. It uses the highly efficient 4FSK modulation, and the protocol sports Golay (23,12) Forward Error Correction, which allows it to accurately decode very weak signals.
...
To achieve it’s long range, this transmitter requires an amateur radio callsign.  This allows you to legally transmit on the 70cm ham radio band.  When you download the codebase to flash to the tracker, you will need to open up the configuration file and enter your Callsign.
...
# Testimonials
> I've used it on two flights, so far, with excellent results.  The range was impressive, and battery life was great.  It was fairly easy to build and install the code from the Arduino environment.   Horus Binary takes a little extra effort to receive, but the trade-off in range and reliability over APRS makes it well worth it.
>- Mike Hojnowski - KD2EAT - Systems Engineer and Amateur Radio Club Advisor at Cornell University

> Using Tiny4FSK for tracking high power rockets is great. It’s easy to integrate, has great battery life, and it gives me total confidence I’ll be able to find my rocket.
>- Jonathan Godfrey - KC1MOL - Director of Research and Development, RIT Launch Initiative